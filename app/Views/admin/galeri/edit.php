...
<div class="mb-8">
    ...
    <h2 class="text-xl text-gray-700 mb-2 flex items-center">
        <i class="fas fa-edit mr-3 text-primary"></i>Edit Galeri
    </h2>
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi" 
                                  name="deskripsi" 
                                  rows="4"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-colors duration-200 resize-vertical"><?= old('deskripsi', $galeri['deskripsi']) ?></textarea>
                    </div>
