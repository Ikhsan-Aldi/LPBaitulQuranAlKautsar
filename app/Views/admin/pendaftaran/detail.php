    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div class="space-y-3">
                    <a href="<?= base_url('file/pendaftaran/'.$pendaftar['ktp_ortu']) ?>" target="_blank" 
                    ...
                    <a href="<?= base_url('file/pendaftaran/'.$pendaftar['akta_kk']) ?>" target="_blank" 
                       class="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200 group">
                        <div class="flex items-center space-x-3">
                    ...
                    <a href="<?= base_url('file/pendaftaran/'.$pendaftar['surat_ket_lulus']) ?>" target="_blank" 
                       class="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200 group">
                        <div class="flex items-center space-x-3">
                    ...
                    <a href="<?= base_url('file/pendaftaran/'.$pendaftar['ijazah_terakhir']) ?>" target="_blank" 
                       class="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200 group">
                        <div class="flex items-center space-x-3">
                    ...
                    <a href="<?= base_url('file/pendaftaran/'.$pendaftar['foto']) ?>" target="_blank" 
                       class="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200 group">
                        <div class="flex items-center space-x-3">
